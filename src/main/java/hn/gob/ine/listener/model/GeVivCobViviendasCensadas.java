...
public class GeVivCobViviendasCensadas {
    ...
    public GeVivCobViviendasCensadas(String depto, String mun, int apoyoMunicipal, int zona, String sector, String segmento,
